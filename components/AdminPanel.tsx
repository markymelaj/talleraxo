...
export default function AdminPanel() {
  ...
  const summary = useMemo(() => {
    ...
    const needsPhoto = opportunities.filter((lead) => lead.status === "falta_foto").length;
    ...
    return { open, needsPhoto, scheduled, total };
  }, [opportunities]);
    ...
    return (
      <main className="panelPage authPage">
        <section className="authCard">
          ...
          <p>
            Pensado para usar desde celular: revisar fotos, cambiar estado, cargar monto estimado y responder por WhatsApp sin buscar datos sueltos.
          </p>
          ...
          <div className="authHint">
            Demo sin Supabase: <strong>demo123</strong>. En cliente real se cambia con <strong>ADMIN_PASSWORD</strong>.
          </div>
      ...
      <div className="adminTop">
        <div className="container adminTopGrid">
          <div>
            ...
            <p>Todo lo que llega desde el cotizador queda ordenado para cotizar, agendar o descartar.</p>
          </div>
      ...
      <div className="container adminContent">
        <section className="adminMetrics" aria-label="Resumen del panel">
          ...
          <div className="adminMetric">
            ...
            <strong>{summary.needsPhoto}</strong>
          </div>
          <div className="adminMetric">
  ...
  return (
    <article className="leadCard">
      <div className="leadCardHeader">
        <div>
          <span className={`statusPill status-${lead.status}`}>{statusLabels[lead.status]}</span>
